...
$rescorer -tdir $tdir  -bdir $base_dir -pr $pr -qs "-l h_vmem=4g,h_rt=60:00:00" -sdir /home/lvapeab -wgdir $wgdir  -o $output -v -debug -name $name -bLM $bLM -test_script $test_script -nbest $nblist -o $output -lambda $lambda
