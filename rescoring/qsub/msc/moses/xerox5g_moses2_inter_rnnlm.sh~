...
nblist=/home/lvapeab/dev.2500
output=${base_dir}/bidir_result

tdir=/home/lvapeab/${name}
sdir=${tdir}
weights=/home/lvapeab/smt/tasks/ue/esen/MOSES/model/mert-work_n2500/run7.weights.txt
...
$rescorer -tdir $tdir  -bdir $base_dir -pr $pr -qs "-l h_vmem=4g,h_rt=5:00:00" -sdir $sdir -v -debug -name $name -bLM $bLM -test_script $test_script -nbest $nblist -o $output